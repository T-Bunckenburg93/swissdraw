...
use views::{Blog, Home, Navbar,New_Draw,Load_Draw,Help,Score_Prior_Games, Enter_Scores, Score_Draw};
...
enum Route {
    ...
    #[layout(Navbar)]
        ...
        Enter_Scores { sd_id: i64 }, 

        #[route("/Score_Draw/:sd_id")]
        Score_Draw { sd_id: i64 }, 
